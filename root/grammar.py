...
def generate_transformed_segment(segment, tag, password_key, **kwargs):
...
def main(db, transformed_cred_id, pwset_id, dryrun, verbose, basepath, tag_type, **kwargs):
    ...
    while db.hasNext():
        ...
        for s in segments:  # semantic tags
            ...
            tags.append(tag)
            transformedSegment = str(generate_transformed_segment(s, tag, password_key, type=kwargs.get("type")))
